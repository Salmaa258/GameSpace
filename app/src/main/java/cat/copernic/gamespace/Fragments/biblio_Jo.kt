...
class Biblio_Jo : Fragment() {
    private var _binding: FragmentBiblioJoBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentBiblioJoBinding.inflate(inflater)
    ...
    private fun initRecyclerView(view: View) {
        ...
        binding.recyclerBiblioJo.adapter = BiblioJoAdapter(BiblioJoList.BiblioJoList.toList())
